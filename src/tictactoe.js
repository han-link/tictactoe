...
function updatePlayground(pushedButton, player) {
    playground[pushedButton.getAttribute("data-y")][pushedButton.getAttribute("data-x")] = player;

}

function isDescribed(pushedButton) {
    if (playground[pushedButton.getAttribute("data-y")][pushedButton.getAttribute("data-x")] != null) {
        return true;
    }
}
